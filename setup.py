...
setup(
  ...
  keywords = ['emailvalidator python','python emailvalidator','email', 'email validation', 'email validator', 'python package for email validation', 'python email validator'], # arbitrary keywords
